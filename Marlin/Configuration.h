...
#define MOTHERBOARD BOARD_BTT_SKR_V1_4  // BTT SKR V1.4 (LPC1768)
...
//#define PSU_NAME "Power Supply"
  ...
  #define PSU_ACTIVE_STATE HIGH     // BIGTREETECH Relay V1.2 uses HIGH
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 24, -37, -1.5 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
